 ...
 */
public class LoginRequestActivity extends Activity implements OnClickListener {
    private String TAG = LoginRequestActivity.class.getSimpleName();
    ...
    public boolean makeJsonArryReq(String username, String password) {
        String url = Const.URL_LOGIN + "username=" + username + "&password=" + password;
        showProgressDialog();
        if (username == null) {
            return false;
        }
    ...
    public boolean onSuccess() {
        startActivity(new Intent(LoginRequestActivity.this,
